...
export function Box({
    ...
    const tokenStyle = useMemo<ViewStyle>(() => {
        ...
        if (paddingX !== undefined)
            s.paddingHorizontal = resolveSpacing(paddingX);
        if (paddingY !== undefined)
            s.paddingVertical = resolveSpacing(paddingY);
        if (paddingTop !== undefined) s.paddingTop = resolveSpacing(paddingTop);
        if (paddingBottom !== undefined)
            s.paddingBottom = resolveSpacing(paddingBottom);
        if (paddingLeft !== undefined)
            s.paddingLeft = resolveSpacing(paddingLeft);
        if (paddingRight !== undefined)
            s.paddingRight = resolveSpacing(paddingRight);
        ...
        if (marginBottom !== undefined)
            s.marginBottom = resolveSpacing(marginBottom);
        if (marginLeft !== undefined) s.marginLeft = resolveSpacing(marginLeft);
        if (marginRight !== undefined)
            s.marginRight = resolveSpacing(marginRight);
    ...
    return (
        <RNView
            style={style ? [tokenStyle, style] : tokenStyle}
            {...viewProps}
        />
    );
}
