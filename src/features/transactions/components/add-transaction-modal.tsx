    ...
    >
        ...
        <View colorValue="transparent" style={formStyles.typeButtons}>
          <Pressable
            ...
            style={[
              ...
              type === 'expense' && formStyles.typeButtonActiveExpense,
            ]}
          ...
          >
            <Text
              style={[
                ...
                type === 'expense' && formStyles.typeButtonTextActive,
              ]}
            >
              Expense
            </Text>
          ...
          <Pressable
            ...
            style={[formStyles.typeButton, type === 'income' && formStyles.typeButtonActiveIncome]}
            accessibilityRole="button"
          ...
          >
            <Text
              style={[
                formStyles.typeButtonText,
                type === 'income' && formStyles.typeButtonTextActive,
              ]}
            >
              Income
            </Text>
        ...
        <Controller
          ...
          render={({ field: { value, onChange, onBlur } }) => (
            <View
              ...
              style={[styles.amountInputContainer, !!errors.amount && styles.inputError]}
            >
      ...
      <FormField label="Account" required error={errors.accountId?.message}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View colorValue="transparent" style={styles.optionsContainer}>
            {accounts.length === 0 ? (
              <Text style={formStyles.emptyText}>No accounts available</Text>
            ) : (
              accounts.map((account) => (
                ...
                >
                  <Text
                    style={[
                      styles.optionText,
                      selectedAccountId === account.id && styles.optionTextActive,
                    ]}
                  >
                    {account.name}
                  </Text>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View colorValue="transparent" style={styles.optionsContainer}>
            {currentCategories.length === 0 ? (
              <Text style={formStyles.emptyText}>No categories available</Text>
            ) : (
