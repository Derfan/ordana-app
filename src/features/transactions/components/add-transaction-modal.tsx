    ...
    >
        ...
        <View style={modalFormStyles.typeButtons}>
          <Pressable
            ...
            style={[
              ...
              type === 'expense' && modalFormStyles.typeButtonActiveExpense,
            ]}>
            <ThemedText
              style={[
                modalFormStyles.typeButtonText,
                type === 'expense' && modalFormStyles.typeButtonTextActive,
              ]}>
              Expense
            </ThemedText>
          </Pressable>
          ...
          <Pressable
            ...
            style={[
              modalFormStyles.typeButton,
              type === 'income' && modalFormStyles.typeButtonActiveIncome,
            ]}>
            <ThemedText
              style={[
                modalFormStyles.typeButtonText,
                type === 'income' && modalFormStyles.typeButtonTextActive,
              ]}>
              Income
            </ThemedText>
          </Pressable>
      ...
      <View style={modalFormStyles.section}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View style={styles.optionsContainer}>
            {accounts.length === 0 ? (
              <ThemedText style={modalFormStyles.emptyText}>No accounts available</ThemedText>
            ) : (
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <View style={styles.optionsContainer}>
            {currentCategories.length === 0 ? (
              <ThemedText style={modalFormStyles.emptyText}>No categories available</ThemedText>
            ) : (
      ...
      <View style={modalFormStyles.section}>
        ...
        <TextInput
          ...
          editable={!isSubmitting}
        />
        <ThemedText style={modalFormStyles.hint}>{description.length}/500 characters</ThemedText>
      </View>
