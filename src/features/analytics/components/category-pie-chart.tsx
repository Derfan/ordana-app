...
import { Box, Text, useTheme } from '@shared/design-system';
        ...
        {data.map((item) => (
          <View key={item.categoryId} style={styles.legendItem}>
            <View style={styles.legendLeft}>
              ...
              <Text variant="bodySemibold">{item.categoryName}</Text>
            </View>
            <View style={styles.legendRight}>
              <Text variant="amount">{formatCurrency(item.totalAmount)}</Text>
              <Text variant="hint" color="muted">
