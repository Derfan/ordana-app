...
export const BalanceSummaryCard = () => {
  ...
  const chartData = analytics.map((item) => {
    ...
    return {
      value: profit,
      label: item.label,
      frontColor: profit > 0 ? theme.colors.accent.success : theme.colors.accent.danger,
    };
  });

  return (
    <Box radius={theme.radii.md} surface="elevated" align="flex-start" padding="md" gapY="sm">
