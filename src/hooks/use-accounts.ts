...
import { selectAccountById, selectTotalBalance, useAccountsStore } from '@store/accounts-store';
...
export function useAccount(id: number) {
  ...
  return {
    account,
    updateAccount: (data: Parameters<typeof updateAccount>[1]) => updateAccount(id, data),
