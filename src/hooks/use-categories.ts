...
import { selectCategoriesByType, selectCategoryById, useCategoriesStore } from '@store/categories-store';
...
export function useCategory(id: number) {
  ...
  return {
    category,
    updateCategory: (data: Parameters<typeof updateCategory>[1]) => updateCategory(id, data),
