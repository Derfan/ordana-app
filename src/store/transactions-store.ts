...
// Selectors
export const selectRecentTransactions = (limit: number) => (state: TransactionsState) =>
  state.transactions.slice(0, limit);

export const selectTransactionsByAccount = (accountId: number) => (state: TransactionsState) =>
  state.transactions.filter((txn) => txn.accountId === accountId);

export const selectTransactionsByCategory = (categoryId: number) => (state: TransactionsState) =>
