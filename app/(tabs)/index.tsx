      ...
      {analytics && (
        <View style={styles.statsContainer}>
          <View style={[styles.statCard, styles.incomeCard]}>
            <ThemedText style={styles.statLabel}>Income ({currentMonth})</ThemedText>
          ...
          <View style={[styles.statCard, styles.expenseCard]}>
            <ThemedText style={styles.statLabel}>Expenses ({currentMonth})</ThemedText>
            <ThemedText style={styles.statAmount}>
                ...
                <View key={txn.id} style={styles.transactionItem}>
                  <View style={styles.transactionLeft}>
                    <View
                      ...
                      <ThemedText style={styles.icon}>{txn.category.icon}</ThemedText>
                    </View>
                    <View style={styles.transactionInfo}>
                      <ThemedText style={styles.categoryName}>{txn.category.name}</ThemedText>
